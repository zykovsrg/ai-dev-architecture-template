...
for task_skill in hub-task-intake hub-task-switch hub-task-finish; do
  ...
  assert_contains "$ROOT/hub-template/ai/skills/$task_skill/SKILL.md" 'generate-obsidian-projects-kanban.sh'
...
assert_contains "$ROOT/hub-template/ai/skills/hub-info-update/SKILL.md" 'generate-obsidian-projects-kanban.sh'
