...
Этот файл — полный индекс системы разработки. Входные файлы `AGENTS.md` и `CLAUDE.md` теперь сжаты и хранят только правила первого уровня. Подробности живут здесь и в `ai/skills/*/SKILL.md`.
...
Должен быть коротким: только правила первого уровня, маршрутизация контекста, режимы работы и формат ответа.
